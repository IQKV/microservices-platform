...
public class CorsConfiguration {
  ...
  @Value("${iqscaffold.bookstore.cors.allowed-origins:http://localhost:5173,http://localhost:3000}")
  private String[] allowedOrigins;

  @Value("${iqscaffold.bookstore.cors.allowed-methods:GET,POST,PUT,DELETE,OPTIONS}")
  private String[] allowedMethods;

  @Value("${iqscaffold.bookstore.cors.allowed-headers:*}")
  private String[] allowedHeaders;

  @Value("${iqscaffold.bookstore.cors.allow-credentials:true}")
  private boolean allowCredentials;

  @Value("${iqscaffold.bookstore.cors.max-age:3600}")
  private long maxAge;
