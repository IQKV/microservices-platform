 ...
 *
 * <p>This configuration implements the IQ Scaffold platform's authentication architecture
...
public class SecurityConfiguration {
   ...
   * <ul>
   *   <li><b>roles</b> - Standard claim used by IQ Scaffold User Service</li>
  ...
  public Converter<Jwt, Collection<GrantedAuthority>> jwtGrantedAuthoritiesConverter() {
    return jwt -> {
      ...
      // Try "roles" claim (IQ Scaffold User Service standard)
