  ...
  public OpenAPI bookstoreOpenAPI() {
    return new OpenAPI()
        .info(new Info()
            ...
            .description("""
                Book catalog and inventory management microservice for the IQ Scaffold platform.
                ...
                **API Versioning**: This API supports multiple versioning strategies:
                ...
                - Content negotiation: `Accept: application/vnd.iqscaffold.bookstore.v1+json`
            ...
            .version("v1.0")
            .contact(new Contact()
                .name("IQ Scaffold Development Team")
                .email("dev@iqscaffold.com")
