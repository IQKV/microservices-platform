...
public class CatalogApplicationService {
  ...
  @Cacheable(value = CacheConfig.BOOK_CACHE,
             key = "T(com.iqscaffold.bookstore.shared.BookstoreConstants.CacheKeyPrefixes).ISBN + #isbn")
  ...
  @Cacheable(value = CacheConfig.POPULAR_BOOKS_CACHE,
             key = "T(com.iqscaffold.bookstore.shared.BookstoreConstants.CacheKeyPrefixes).AVAILABLE + #pageable.pageNumber + '_' + #pageable.pageSize")
  ...
  @Transactional(readOnly = true)
  @Cacheable(value = CacheConfig.POPULAR_BOOKS_CACHE,
             key = "T(com.iqscaffold.bookstore.shared.BookstoreConstants.CacheKeyPrefixes).IN_STOCK + #pageable.pageNumber + '_' + #pageable.pageSize")
  ...
  @Transactional(readOnly = true)
  @Cacheable(value = CacheConfig.BOOK_SEARCH_CACHE,
             key = "T(com.iqscaffold.bookstore.shared.BookstoreConstants.CacheKeyPrefixes).CATALOG_RESPONSE + #query.toString() + '_' + #pageable.pageNumber + '_' + #pageable.pageSize")
