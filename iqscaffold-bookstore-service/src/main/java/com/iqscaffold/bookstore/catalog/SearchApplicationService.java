...
public class SearchApplicationService {
  ...
  @Cacheable(value = CacheConfig.BOOK_SEARCH_CACHE,
             key = "T(com.iqscaffold.bookstore.shared.BookstoreConstants.CacheKeyPrefixes).TITLE + #title + '_' + #pageable.pageNumber + '_' + #pageable.pageSize")
  ...
  @Cacheable(value = CacheConfig.BOOK_SEARCH_CACHE,
             key = "T(com.iqscaffold.bookstore.shared.BookstoreConstants.CacheKeyPrefixes).AUTHOR + #author + '_' + #pageable.pageNumber + '_' + #pageable.pageSize")
  ...
  @Cacheable(value = CacheConfig.BOOK_SEARCH_CACHE,
             key = "T(com.iqscaffold.bookstore.shared.BookstoreConstants.CacheKeyPrefixes).CATEGORY + #category + '_' + #pageable.pageNumber + '_' + #pageable.pageSize")
  ...
  @Cacheable(value = CacheConfig.AUTHOR_CACHE,
             key = "T(com.iqscaffold.bookstore.shared.BookstoreConstants.CacheKeyPrefixes).DISTINCT_AUTHORS")
  ...
  @Cacheable(value = CacheConfig.CATEGORY_CACHE,
             key = "T(com.iqscaffold.bookstore.shared.BookstoreConstants.CacheKeyPrefixes).DISTINCT_CATEGORIES")
  ...
  @Cacheable(value = CacheConfig.BOOK_SEARCH_CACHE,
             key = "T(com.iqscaffold.bookstore.shared.BookstoreConstants.CacheKeyPrefixes).FULLTEXT + #searchTerm + '_' + #pageable.pageNumber + '_' + #pageable.pageSize")
  ...
  @Cacheable(value = CacheConfig.BOOK_SEARCH_CACHE,
             key = "T(com.iqscaffold.bookstore.shared.BookstoreConstants.CacheKeyPrefixes).FUZZY + #searchTerm + '_' + #pageable.pageNumber + '_' + #pageable.pageSize")
  ...
  @Cacheable(value = CacheConfig.BOOK_SEARCH_CACHE,
             key = "T(com.iqscaffold.bookstore.shared.BookstoreConstants.CacheKeyPrefixes).PRICE_RANGE + #minPrice + '_' + #maxPrice + '_' + #categoryId + '_' + #pageable.pageNumber")
