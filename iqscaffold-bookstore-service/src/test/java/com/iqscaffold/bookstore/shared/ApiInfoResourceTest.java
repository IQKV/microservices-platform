...
import com.iqscaffold.bookstore.shared.web.ApiInfoResource;
...
class ApiInfoResourceTest {
  ...
  void shouldReturnAllVersioningStrategies() throws Exception {
    ...
    mockMvc.perform(get("/api/v1/bookstore/version"))
        ...
        .andExpect(jsonPath("$.versioningStrategies[2]").value("Content Negotiation (Accept: application/vnd.iqscaffold.bookstore.v1+json)"))
