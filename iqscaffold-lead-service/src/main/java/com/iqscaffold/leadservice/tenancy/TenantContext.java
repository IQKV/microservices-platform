...
import com.iqscaffold.leadservice.shared.LeadConstants;
import com.iqscaffold.leadservice.shared.exception.TenantContextException;
...
public final class TenantContext {
  ...
  public static void setCurrentTenantId(String tenantId) {
    ...
    MDC.put(LeadConstants.MDC.TENANT_ID, normalizedTenantId);
  }
   ...
   * @see #getCurrentTenantId()
   * @see LeadConstants.Defaults#DEFAULT_TENANT_ID
   */
  public static String getCurrentTenantIdOrDefault() {
    var tenantId = TENANT_CONTEXT.get();
    return tenantId != null ? tenantId : LeadConstants.Defaults.DEFAULT_TENANT_ID;
  }
  ...
  public static void clear() {
    ...
    MDC.remove(LeadConstants.MDC.TENANT_ID);
  }
   ...
   * Lead lead = TenantContext.executeInTenantContext("tenant-123", () -> {
  ...
  public static String getDefaultTenantId() {
    return LeadConstants.Defaults.DEFAULT_TENANT_ID;
  }
   ...
   * <h4>Example:</h4>
   * <pre>{@code
   * String cacheKey = TenantContext.createTenantAwareCacheKey("lead:" + leadId);
   * // Returns: "tenant-123:lead:12345"
   * }</pre>
   *
