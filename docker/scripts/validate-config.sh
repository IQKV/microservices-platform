...
validate "-f gripday-user-service/docker-compose.yml" "user-service"
validate "-f gripday-gateway-service/docker-compose.yml" "gateway-service"
...
for file in docker/postgres/init-user.sql docker/prometheus/prometheus.yml \
    ...
    gripday-user-service/Dockerfile gripday-gateway-service/Dockerfile; do
