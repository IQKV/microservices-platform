...
public class PaymentStateMachine {
    ...
    public PaymentStateMachine(MessageService messageService) {
    ...
    private boolean isValidTransition(String from, String to) {
        if (from == null) return BillingConstants.PaymentStatus.PENDING.equals(to); // Initial creation

        return switch (from) {
            case BillingConstants.PaymentStatus.PENDING -> 
                to.equals(BillingConstants.PaymentStatus.SUCCEEDED) || 
                to.equals(BillingConstants.PaymentStatus.FAILED);
                
            case BillingConstants.PaymentStatus.SUCCEEDED -> 
                to.equals(BillingConstants.PaymentStatus.REFUNDED) || 
