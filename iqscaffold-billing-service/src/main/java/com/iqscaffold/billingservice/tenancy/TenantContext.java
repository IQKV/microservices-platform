...
public final class TenantContext {
   ...
   * @see #getCurrentTenantId()
   * @see BillingConstants.Defaults#DEFAULT_TENANT_ID
   */
   ...
   * Payment payment = TenantContext.executeInTenantContext("tenant-123", () -> {
   ...
   * <h4>Example:</h4>
   * <pre>{@code
   * String cacheKey = TenantContext.createTenantAwareCacheKey("payment:" + paymentId);
   * // Returns: "tenant-123:payment:12345"
   * }</pre>
   *
