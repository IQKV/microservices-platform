...
GRANT USAGE ON SCHEMA bookstore TO bookstore_user;
GRANT CREATE ON SCHEMA bookstore TO bookstore_user;

-- Set connection limits (optional)
ALTER USER bookstore_user CONNECTION LIMIT 50;

-- Configure default privileges for future objects
ALTER DEFAULT PRIVILEGES IN SCHEMA bookstore GRANT ALL ON TABLES TO bookstore_user;
ALTER DEFAULT PRIVILEGES IN SCHEMA bookstore GRANT ALL ON SEQUENCES TO bookstore_user;
ALTER DEFAULT PRIVILEGES IN SCHEMA bookstore GRANT ALL ON FUNCTIONS TO bookstore_user;