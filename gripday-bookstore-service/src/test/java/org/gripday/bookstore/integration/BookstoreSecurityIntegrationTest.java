...
/**
 * Integration tests focused on security, authentication, and authorization scenarios.
 * Tests various user roles and permission combinations in realistic security contexts.
 */
@SpringBootTest
@ActiveProfiles("test")
@Transactional
