...
import org.gripday.userservice.presentation.validation.ValidPassword;
import org.gripday.userservice.presentation.validation.ValidUsername;

/**
 * Request DTO for user registration using Java 21 record. Contains validation annotations for input validation and security.
 */
@Schema(
    name = "SignupRequest",
    description = "User registration request with validation",
    example = """
        {
          "username": "john.doe",
