...
import org.gripday.userservice.security.ValidPassword;
import org.gripday.userservice.security.ValidUsername;

/**
 * Request DTO for user registration. Contains validation annotations for input validation and security.
 */
@Schema(
    name = "SignupRequest",
