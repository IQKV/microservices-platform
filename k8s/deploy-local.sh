...
verify_deployment() {
    ...
    print_status "  $(minikube ip) auth.pynity.site"
    print_status "  $(minikube ip) api.pynity.site"
    print_status ""
    print_status "Access services:"
    print_status "  Auth Service: http://auth.pynity.site"
    print_status "  Gateway Service: http://api.pynity.site"
    print_status "  Bookstore Service: http://localhost/api/v1/bookstore"
    print_status ""
    print_status "Swagger UI:"
    print_status "  Auth Service: http://auth.pynity.site/swagger-ui.html"
