...
verify_deployment() {
    ...
    print_status "  $(minikube ip) auth.gripday.dev"
    print_status "  $(minikube ip) api.gripday.dev"
    print_status ""
    print_status "Access services:"
    print_status "  Auth Service: http://auth.gripday.dev"
    print_status "  Gateway Service: http://api.gripday.dev"
    print_status "  Bookstore Service: http://localhost/api/v1/bookstore"
    print_status ""
    print_status "Swagger UI:"
    print_status "  Auth Service: http://auth.gripday.dev/swagger-ui.html"
