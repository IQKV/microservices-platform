...
verify_deployment() {
    ...
    print_status "  $(minikube ip) user.gripday.site"
    print_status "  $(minikube ip) api.gripday.site"
    print_status ""
    print_status "Access services:"
    print_status "  User Service: http://user.gripday.site"
    ...
    print_status "  User Service: http://user.gripday.site/swagger-ui.html"
