...
public class ApiVersionExtractor {
  ...
  private static final Pattern ACCEPT_VERSION_PATTERN = Pattern.compile("application/vnd\\.iqscaffold\\.(v\\d+)\\+json");
  ...
  /**
   * Extract version from Accept header with vendor media type Example: application/vnd.iqscaffold.v1+json -> v1
   */
