...
public class ApiPrefixService {
  ...
  public ApiPrefixService(final IqScaffoldProperties properties) {
  ...
  public String getPrefix() {
    return properties.gateway().routing().apiPrefix().prefix();
  }
  ...
  public int getStripCount() {
    return properties.gateway().routing().apiPrefix().stripCount();
  }
  ...
  public boolean isEnabled() {
    return properties.gateway().routing().apiPrefix().enabled();
  }
