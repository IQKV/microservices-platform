...
class ObservabilityPropertiesTest {
  ...
  class TracingPropertiesTests {
    ...
    void shouldValidateSuccessfullyWithValidTracingProperties() {
      var tracingProperties = new IqScaffoldProperties.ObservabilityProperties.TracingProperties(
          true,
          "gateway-service",
          0.1,
          "http://jaeger:14250",
      ...
      Set<ConstraintViolation<IqScaffoldProperties.ObservabilityProperties.TracingProperties>> violations = validator.validate(tracingProperties);
  ...
  class MetricsPropertiesTests {
    ...
    void shouldValidateSuccessfullyWithValidMetricsProperties() {
      var metricsProperties = new IqScaffoldProperties.ObservabilityProperties.MetricsProperties(
          true,
          "/actuator/metrics",
          "gateway",
          true,
      ...
      Set<ConstraintViolation<IqScaffoldProperties.ObservabilityProperties.MetricsProperties>> violations = validator.validate(metricsProperties);
  ...
  class LoggingPropertiesTests {
    ...
    void shouldValidateSuccessfullyWithValidLoggingProperties() {
      var loggingProperties = new IqScaffoldProperties.ObservabilityProperties.LoggingProperties(
          "INFO",
          "json",
          true,
          true,
      ...
      Set<ConstraintViolation<IqScaffoldProperties.ObservabilityProperties.LoggingProperties>> violations = validator.validate(loggingProperties);
