...
class ApiPrefixServiceTest {
  ...
  @Mock(lenient = true)
  private IqScaffoldProperties.GatewayProperties.RoutingProperties routing;

  @Mock(lenient = true)
  private IqScaffoldProperties.GatewayProperties.RoutingProperties.ApiPrefixProperties apiPrefix;
  ...
  void setUp() {
    ...
    apiPrefixService = new ApiPrefixService(properties);
  }
