...
- `POST /api/v1/auth/password/forgot` - Initiate password reset (non-enumerating)
...
- Interactive Swagger UI: [Gateway](http://localhost:8080/swagger-ui.html) | [User Service](http://localhost:8080/swagger-ui.html)
