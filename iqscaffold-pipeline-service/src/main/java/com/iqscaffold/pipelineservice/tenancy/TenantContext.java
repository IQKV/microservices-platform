...
import com.iqscaffold.pipelineservice.shared.PipelineConstants;
import com.iqscaffold.pipelineservice.shared.exception.TenantContextException;
...
public final class TenantContext {
  ...
  public static void setCurrentTenantId(String tenantId) {
    ...
    MDC.put(PipelineConstants.MDC.TENANT_ID, normalizedTenantId);
  }
   ...
   * @see #getCurrentTenantId()
   * @see PipelineConstants.Defaults#DEFAULT_TENANT_ID
   */
  public static String getCurrentTenantIdOrDefault() {
    var tenantId = TENANT_CONTEXT.get();
    return tenantId != null ? tenantId : PipelineConstants.Defaults.DEFAULT_TENANT_ID;
  }
  ...
  public static void clear() {
    ...
    MDC.remove(PipelineConstants.MDC.TENANT_ID);
  }
   ...
   *     pipelineService.createPipelineItem(itemRequest);
   * });
   ...
   * PipelineItem item = TenantContext.executeInTenantContext("tenant-123", () -> {
   *     return pipelineItemRepository.findById(itemId);
   * });
   * // Original tenant context automatically restored
   * }</pre>
   *
  ...
  public static String getDefaultTenantId() {
    return PipelineConstants.Defaults.DEFAULT_TENANT_ID;
  }
   ...
   * <h4>Example:</h4>
   * <pre>{@code
   * String cacheKey = TenantContext.createTenantAwareCacheKey("pipeline:" + itemId);
   * // Returns: "tenant-123:pipeline:12345"
   * }</pre>
   *
