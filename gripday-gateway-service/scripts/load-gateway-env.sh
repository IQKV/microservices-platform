...
get_required_variables() {
    ...
    case "$env" in
        "local")
            echo "SPRING_PROFILES_ACTIVE GRIPDAY_CACHE_REDIS_HOST GRIPDAY_GATEWAY_ROUTING_USER_SERVICE_URI GRIPDAY_GATEWAY_SECURITY_JWT_SECRET GRIPDAY_GATEWAY_SECURITY_USER_SERVICE_URL GRIPDAY_GATEWAY_CORS_ALLOWED_ORIGINS"
            ;;
        "staging")
            echo "SPRING_PROFILES_ACTIVE GRIPDAY_CACHE_REDIS_HOST GRIPDAY_CACHE_REDIS_PASSWORD GRIPDAY_GATEWAY_ROUTING_USER_SERVICE_URI GRIPDAY_GATEWAY_SECURITY_JWT_SECRET GRIPDAY_GATEWAY_SECURITY_USER_SERVICE_URL GRIPDAY_GATEWAY_CORS_ALLOWED_ORIGINS JWT_SECRET REDIS_PASSWORD"
            ;;
        "production")
            echo "SPRING_PROFILES_ACTIVE GRIPDAY_CACHE_REDIS_HOST GRIPDAY_CACHE_REDIS_PASSWORD GRIPDAY_GATEWAY_ROUTING_USER_SERVICE_URI GRIPDAY_GATEWAY_SECURITY_JWT_SECRET GRIPDAY_GATEWAY_SECURITY_USER_SERVICE_URL GRIPDAY_GATEWAY_CORS_ALLOWED_ORIGINS REDIS_HOST JWT_SECRET ALLOWED_ORIGINS"
            ;;
    esac
}
...
display_configuration_summary() {
    ...
    echo "  - User Service URI: $GRIPDAY_GATEWAY_ROUTING_USER_SERVICE_URI"
    echo "  - User Service URL: $GRIPDAY_GATEWAY_SECURITY_USER_SERVICE_URL"
