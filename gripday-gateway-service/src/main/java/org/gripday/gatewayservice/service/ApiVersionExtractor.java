...
/**
 * Service for extracting API version from HTTP requests.
 * Supports URL path-based and header-based version detection.
 */
@Service
public class ApiVersionExtractor {
     ...
     * 1. URL path-based versioning (/api/v1/users)
    ...
    /**
     * Extract version from Accept header with vendor media type
     * Example: application/vnd.gripday.v1+json -> v1
     */
