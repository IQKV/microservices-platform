...
/**
 * Configuration properties for Gripday gateway observability features.
 * Provides centralized configuration for tracing, metrics, and logging in reactive applications.
 */
