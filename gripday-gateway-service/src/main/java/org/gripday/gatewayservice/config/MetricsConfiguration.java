...
/**
 * Configuration for Prometheus metrics collection and customization in the gateway service.
 * Provides environment-specific metric tags and filtering for reactive applications.
 */
@Configuration
...
public class MetricsConfiguration {
    ...
    public MetricsConfiguration(GripdayGatewayObservabilityProperties observabilityProperties, Environment environment) {
