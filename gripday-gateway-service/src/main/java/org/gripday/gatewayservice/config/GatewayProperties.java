...
/**
 * Configuration properties for the Gateway Service with gripday prefix.
 * Provides centralized configuration for routing, security, rate limiting, and observability.
 */
