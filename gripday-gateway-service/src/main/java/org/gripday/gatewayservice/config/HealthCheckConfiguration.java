...
/**
 * Configuration for custom health checks in the gateway service.
 * Provides reactive health indicators for Redis, downstream services, and gateway-specific components.
 */
@Configuration
