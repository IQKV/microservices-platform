...
/**
 * Configuration for structured logging utilities and helpers in the gateway service.
 * Provides consistent logging patterns for reactive applications and request/response correlation.
 */
@Configuration
