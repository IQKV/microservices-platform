...
/**
 * Global filter for API version routing and transformation.
 * Extracts API version from requests and adds version headers for downstream services.
 */
@Component
public class ApiVersionRoutingFilter implements GlobalFilter, Ordered {
    ...
    /**
     * Transform path for version routing.
     * For backward compatibility, routes older versions to appropriate endpoints.
     */
