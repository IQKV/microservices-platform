 ...
 * - Component placement in appropriate packages
 * - Three-tier architecture package structure
 * - Gateway-specific package conventions
 * - REST controller placement and naming (Resource suffix)
 */
@AnalyzeClasses(packages = "org.gripday.gatewayservice")
class PackageStructureTest {

    /**
     * Validates that all classes are in the proper base package.
     * Ensures consistent package naming across the gateway service.
     */
    @ArchTest
    ...
    /**
     * Validates that configuration classes are in config package.
     * Ensures proper organization of configuration components.
     */
    @ArchTest
    ...
    /**
     * Validates that filter classes are in filter package.
     * Ensures proper organization of gateway filter components.
     */
    @ArchTest
    ...
    /**
     * Validates that service classes are in service package.
     * Ensures proper organization of business logic components.
     */
    @ArchTest
    ...
    /**
     * Validates that security classes are in security package.
     * Ensures proper organization of security-related components.
     */
    @ArchTest
    ...
    /**
     * Validates that REST controllers (if any) are in presentation.web package.
    ...
    /**
     * Validates that REST controllers have Resource suffix.
    ...
    /**
     * Validates that component classes follow proper naming conventions.
     * Ensures consistent naming patterns across gateway components.
     */
    @ArchTest
    ...
    /**
     * Validates that service classes follow proper naming conventions.
     * Ensures consistent service naming patterns.
     */
    @ArchTest
    ...
    /**
     * Validates that utility classes are properly organized.
     * Ensures utility components don't pollute main packages.
     */
    @ArchTest
    ...
    /**
     * Validates that exception classes are properly organized.
     * Ensures error handling components are in appropriate packages.
     */
    @ArchTest
    ...
    /**
     * Validates that the main application class is in the root package.
     * Ensures proper Spring Boot application structure.
     */
    @Test
    ...
    /**
     * Validates that package structure follows gateway service conventions.
     * Ensures proper organization of gateway-specific components.
     */
    @Test
    ...
    /**
     * Validates that no classes are in inappropriate packages.
     * Ensures clean package organization without misplaced components.
     */
    @Test
    ...
    /**
     * Validates that three-tier architecture packages are properly structured.
     * Ensures consistency with platform-wide architectural standards.
     */
    @Test
