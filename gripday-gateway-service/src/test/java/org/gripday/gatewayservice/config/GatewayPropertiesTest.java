...
class GatewayPropertiesTest {
  ...
  class EndpointPolicyPropertiesTests {
    ...
    void shouldValidateSuccessfullyWithValidEndpointPolicyProperties() {
      ...
      Set<ConstraintViolation<GripdayProperties.GatewayProperties.RateLimitingProperties.PoliciesProperties.EndpointPolicyProperties>> violations =
  ...
  class ResponseTransformationPropertiesTests {
    ...
    void shouldValidateSuccessfullyWithValidResponseTransformationProperties() {
      ...
      Set<ConstraintViolation<GripdayProperties.GatewayProperties.TransformationProperties.ResponseTransformationProperties>> violations =
