...
/**
 * Configuration for structured logging utilities and helpers.
 * Provides consistent logging patterns and correlation ID management.
 */
@Configuration
...
public class StructuredLoggingConfiguration {
    ...
    public static class SecurityLogger {
        ...
        private static final Logger securityLogger = LoggerFactory.getLogger("org.gripday.authservice.security");
