...
import org.gripday.authservice.domain.service.TenantExtractionService;
...
/**
 * Filter for early tenant context establishment in the filter chain.
 * Extracts tenant information from various sources and sets up tenant context
 * before other filters and controllers are executed.
 */
@Component
