...
/**
 * Redis configuration for Auth Service with tenant-aware caching and session management.
 * Configures Redis connection, serialization, tenant-isolated caching, and session storage.
 */
@Configuration
@EnableCaching
...
public class RedisConfiguration extends AbstractHttpSessionApplicationInitializer {
    ...
    /**
     * Tenant-aware session key serializer for session management with tenant isolation.
     * Ensures session keys are properly namespaced by tenant ID.
     */
     ...
     * Provides high-level methods for tenant-isolated caching and session management.
     */
    @Bean
    ...
    /**
     * Service for tenant-aware session management.
     * Provides session operations with automatic tenant isolation.
     */
    @Bean
    ...
    public static class TenantAwareSessionService {
        ...
        /**
         * Store user session mapping with tenant isolation.
         * Allows tracking all sessions for a specific user.
         */
