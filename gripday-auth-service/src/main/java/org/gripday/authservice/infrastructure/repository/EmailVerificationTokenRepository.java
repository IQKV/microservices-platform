...
/**
 * Repository interface for EmailVerificationToken entity operations.
...
public interface EmailVerificationTokenRepository extends JpaRepository<EmailVerificationToken, Long> {
    ...
    /**
     * Delete all tokens that have expired before the specified date.
     * Used for cleanup of old verification tokens.
     * 
     ...
     * Used when invalidating existing tokens before generating new ones.
     * 
