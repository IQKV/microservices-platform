...
/**
 * Base class for entities that are tenant-aware and require automatic tenant ID injection.
...
public abstract class TenantAwareEntity {
    ...
    /**
     * Automatically inject tenant ID from current tenant context before persisting.
     * This method is called by JPA before the entity is persisted.
     */
    @PrePersist
    ...
    /**
     * Validate tenant context before updating entity.
     * Ensures that updates are only performed within the correct tenant context.
     */
    @PreUpdate
