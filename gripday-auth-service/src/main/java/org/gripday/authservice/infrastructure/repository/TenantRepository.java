 ...
 * Provides tenant management operations for multi-tenant architecture.
 */
@Repository
public interface TenantRepository extends JpaRepository<Tenant, Long> {
    ...
    /**
     * Find tenants with user count within specified limits using custom query.
     * This query joins with users table to count users per tenant.
     * 
    ...
    /**
     * Get tenant statistics using custom query with text blocks.
     * Returns tenant ID, name, user count, and enabled status.
     * 
