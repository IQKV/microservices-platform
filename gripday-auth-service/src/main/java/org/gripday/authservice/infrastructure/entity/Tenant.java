...
/**
 * Tenant entity representing isolated customer environments in the multi-tenant architecture.
 * Each tenant has its own isolated data and configuration settings.
 */
@Entity
@Table(name = "tenants")
public class Tenant {
