...
public class AuthenticationService {
    ...
    /**
     * Initiate password reset flow by generating a one-time token and sending an email.
     * This method is idempotent and always returns successfully to avoid user enumeration.
     */
