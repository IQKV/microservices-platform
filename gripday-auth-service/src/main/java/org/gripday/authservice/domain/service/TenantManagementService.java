...
/**
 * Service for tenant management operations including CRUD operations and schema provisioning.
 * Handles multi-tenant architecture support with comprehensive tenant lifecycle management.
 */
@Service
@Transactional
