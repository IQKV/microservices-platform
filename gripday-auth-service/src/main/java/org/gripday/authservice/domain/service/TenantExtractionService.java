...
import org.gripday.authservice.infrastructure.repository.dto.TenantDto.TenantResolutionResult;
...
/**
 * Service for extracting tenant information from various sources including
 * JWT tokens, custom headers, and subdomain routing.
 */
@Service
public class TenantExtractionService {
    ...
    /**
     * Extract tenant ID from HTTP request using multiple resolution strategies.
     * Tries in order: JWT token, custom header, subdomain.
     * 
