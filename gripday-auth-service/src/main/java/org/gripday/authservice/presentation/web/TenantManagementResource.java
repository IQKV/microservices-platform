 ...
 * Provides admin-only APIs for tenant CRUD operations and management.
 * All endpoints require SUPER_ADMIN role for access.
 */
@RestController
...
public class TenantManagementResource {
    ...
    @Operation(
        ...
        description = "Retrieve comprehensive tenant statistics including user counts and quota utilization. Requires SUPER_ADMIN role."
    )
    @ApiResponses({
