...
/**
 * Test class for Redis configuration with tenant-aware caching and session management.
 * Tests basic Redis operations, tenant isolation, and session management functionality.
 */
@SpringBootTest
@ActiveProfiles("test")
