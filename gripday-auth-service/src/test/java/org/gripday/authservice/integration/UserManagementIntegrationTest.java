...
/**
 * Integration tests for user management endpoints focusing on happy path scenarios.
 * Tests admin-only CRUD operations with proper role-based access control and tenant isolation.
 */
