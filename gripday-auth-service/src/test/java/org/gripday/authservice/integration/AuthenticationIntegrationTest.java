...
/**
 * Integration tests for authentication endpoints focusing on happy path scenarios.
 * Tests complete authentication flows with valid credentials and tenant isolation.
 */
