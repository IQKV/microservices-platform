...
/**
 * Integration tests for email verification endpoints focusing on core functionality.
 * Tests complete email verification flows with valid tokens and multi-tenant isolation.
 */
