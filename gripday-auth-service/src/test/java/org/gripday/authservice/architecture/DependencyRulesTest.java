 ...
 * - Proper dependency direction between layers
 * - Prevention of circular dependencies
 * - Enforcement of three-tier architecture principles
...
class DependencyRulesTest {
    ...
    /**
     * Critical rule: REST controllers must NOT directly access repositories.
     * This enforces the three-tier architecture by requiring controllers
     * to go through domain services for data access.
     */
    @ArchTest
     ...
     * Provides additional protection against bypassing the service layer.
     */
    @ArchTest
    ...
    /**
     * Ensures that controllers don't directly access entity classes.
     ...
     * Allows DTOs to be shared but prevents direct repository access.
     */
    @ArchTest
    ...
    /**
     * Validates that infrastructure layer doesn't depend on presentation layer.
     ...
     * Validates proper encapsulation of data access concerns.
     */
    @ArchTest
     ...
     * Validates that validation classes are only used by presentation layer.
     */
    @ArchTest
    ...
    /**
     * Validates that exception handling is properly layered.
     * Ensures exceptions are handled at appropriate layers.
     */
    @ArchTest
     ...
     * Validates that configuration is properly isolated.
     */
    @ArchTest
     ...
     * Ensures that services depend on abstractions, not implementations.
     */
    @ArchTest
