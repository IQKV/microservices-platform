...
ALTER DATABASE gripday_auth SET search_path TO auth, public;
...
GRANT CONNECT ON DATABASE gripday_auth TO auth_app_user;
GRANT USAGE ON SCHEMA auth TO auth_app_user;
GRANT CREATE ON SCHEMA auth TO auth_app_user;
