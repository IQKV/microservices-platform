...
GRIPDAY_USER_SERVICE_NAME=gripday-user-service
GRIPDAY_USER_SERVICE_VERSION=1.0.0
SERVER_PORT=8080
...
# Gateway Routes
GRIPDAY_GATEWAY_USER_SERVICE_URL=http://localhost:8080
GRIPDAY_GATEWAY_ROUTES_USER_SERVICE_URI=http://localhost:8080
GRIPDAY_GATEWAY_ROUTES_USER_SERVICE_PREDICATES=Path=/api/v1/auth/**
...
# Gateway Routes
GRIPDAY_GATEWAY_USER_SERVICE_URL=http://user-service-staging:8080
GRIPDAY_GATEWAY_ROUTES_USER_SERVICE_URI=http://user-service-staging:8080
...
# Gateway Routes
GRIPDAY_GATEWAY_USER_SERVICE_URL=${USER_SERVICE_URL}
GRIPDAY_GATEWAY_ROUTES_USER_SERVICE_URI=${USER_SERVICE_URL}
...
gripday:
  gateway:
    service:
      ...
      version: 1.0.0
    user-service-url: ${GRIPDAY_GATEWAY_USER_SERVICE_URL:http://localhost:8080}
    rate-limiting:
    ...
    routes:
      user-service:
        uri: ${GRIPDAY_GATEWAY_ROUTES_USER_SERVICE_URI:http://localhost:8080}
        predicates: ${GRIPDAY_GATEWAY_ROUTES_USER_SERVICE_PREDICATES:Path=/api/v1/auth/**}
  cache:
    redis:
      host: ${GRIPDAY_CACHE_REDIS_HOST:localhost}
      port: ${GRIPDAY_CACHE_REDIS_PORT:6379}
