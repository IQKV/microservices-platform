...
// Records for DTOs
public record UserContext(Long userId, String username, Set<String> roles, Map<String, Object> customClaims) {}
...
- AUTH\_\* for authentication and authorization errors
- VALIDATION\_\* for input validation errors
- RESOURCE\_\* for resource-related errors
- DOMAIN\_\* for business logic violations
- SYSTEM\_\* for technical system errors
- RATE\_\* for rate limiting errors
