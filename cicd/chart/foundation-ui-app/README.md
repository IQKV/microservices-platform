...
helm install admin-dashboard ./foundation-ui-app -f values-sit.yaml

# Staging environment
helm install admin-dashboard ./foundation-ui-app -f values-uat.yaml

# Production environment
helm install admin-dashboard ./foundation-ui-app -f values-prd.yaml
```
...
```bash
kubectl get pods -l "app.kubernetes.io/name=foundation-ui-app"
```

### View Logs

```bash
kubectl logs -l "app.kubernetes.io/name=foundation-ui-app"
```

### Check Configuration

```bash
kubectl get configmap <release-name>-foundation-ui-app-config -o yaml
```

### Port Forward for Local Access

```bash
kubectl port-forward svc/<release-name>-foundation-ui-app 8080:80
```
