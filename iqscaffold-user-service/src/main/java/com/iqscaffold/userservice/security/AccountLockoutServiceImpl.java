...
/**
 * Implementation of AccountLockoutService providing distributed brute force protection.
 *
...
public class AccountLockoutServiceImpl implements AccountLockoutService {
  ...
  public AccountLockoutServiceImpl(final RedisTemplate<String, String> redisTemplate) {
